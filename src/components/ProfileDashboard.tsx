              ...
              <section className="deba-profile-security-card">
                <div className="deba-profile-security-head">
                  ...
                  <div>
                    ...
                    <span>متاحة للطلبات المؤهلة بعد تهيئة مزود الدفع على بيئة DEBA.</span>
                  </div>
                </div>
                <p>
                  يبدأ الدفع الإلكتروني من الطلب بعد إنشاء جلسة دفع موثقة. حالة الدفع النهائية
                  تعتمد على إشعار مزود الدفع الموثق، ولا تُعرض حالة نجاح من واجهة المتصفح وحدها.
                </p>
              </section>
