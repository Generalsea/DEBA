...
comment on table public.chat_security_events is
  'Safety ledger for marketplace chat. Normal web browsers cannot expose MAC addresses over HTTPS; mac_address is therefore nullable and remains empty for web sessions.';
